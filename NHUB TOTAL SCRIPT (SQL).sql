...
create procedure proc_inserturl
(@TemplateId int,
@ChannelId int,
@Url nvarchar(500),
@ApprovalStatusId int )
as begin
insert into TemplateChannel(TemplateId,ChannelId,Url,ApprovalStatusId)
 values(@TemplateId,@ChannelId,@Url,@ApprovalStatusId)
end


ALTER procedure [dbo].[proc_inser]
(@TemplateName nvarchar(50),
@OperationManagerId nvarchar(128),
@ServiceLineId int,
@EventId int,
@ApprovalStatusId int)
as begin
insert into Template(Name,OperationManagerId,ServiceLineId,EventId,ApprovalStatusId) values
(@TemplateName,@OperationManagerId,@ServiceLineId,@EventId,@ApprovalStatusId)
end
ALTER procedure [dbo].[proc_delete]
(@TemplateId int)
as begin
delete from TemplateChannel where TemplateId=@TemplateId
